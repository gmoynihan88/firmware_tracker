...
This scrapes 60 manufacturers on a schedule, compares what it finds against the gear
...
- **Scrapes 60 manufacturers** — Ableton, Akai, Apple (Logic Pro,
...
**Add devices** from the catalogue at `/catalog`. 1,191 devices across 60 vendors, so it
...
src/
  ...
  scrapers/
    ...
    plugins/           # One file per manufacturer (60 scrapers)
