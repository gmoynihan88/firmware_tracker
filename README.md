...
This scrapes 40 manufacturers on a schedule, compares what it finds against the gear
...
- **Scrapes 40 manufacturers** — Ableton, Akai, Arturia, Bitwig, Boss, Elektron, Eventide,
...
**Add devices** from the catalogue at `/catalog`. 907 devices across 40 vendors, so it
...
src/
  ...
  scrapers/
    ...
    plugins/           # One file per manufacturer (40 scrapers)
