...
This scrapes 37 manufacturers on a schedule, compares what it finds against the gear
...
- **Scrapes 37 manufacturers** — Ableton, Akai, Arturia, Boss, Elektron, Eventide,
...
**Add devices** from the catalogue at `/catalog`. 821 devices across 37 vendors, so it
...
src/
  ...
  scrapers/
    ...
    plugins/           # One file per manufacturer (37 scrapers)
