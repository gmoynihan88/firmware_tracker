...
This scrapes 49 manufacturers on a schedule, compares what it finds against the gear
...
- **Scrapes 49 manufacturers** — Ableton, Akai, Arturia, Bitwig, Boss, Cableguys,
  ...
  Neural DSP, Novation, Soundtoys, Steinberg, Strymon, Teenage Engineering, Tokyo Dawn
  Labs, u-he, Universal Audio, Valhalla DSP, Xfer Records, Zoom and more
...
**Add devices** from the catalogue at `/catalog`. 999 devices across 49 vendors, so it
...
src/
  ...
  scrapers/
    ...
    plugins/           # One file per manufacturer (49 scrapers)
