...
This scrapes 45 manufacturers on a schedule, compares what it finds against the gear
...
- **Scrapes 45 manufacturers** — Ableton, Akai, Arturia, Bitwig, Boss, Elektron, Eventide,
...
**Add devices** from the catalogue at `/catalog`. 950 devices across 45 vendors, so it
...
src/
  ...
  scrapers/
    ...
    plugins/           # One file per manufacturer (45 scrapers)
