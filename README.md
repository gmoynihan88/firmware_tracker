...
This scrapes 66 manufacturers on a schedule, compares what it finds against the gear
...
- **Scrapes 66 manufacturers** — Ableton, Akai, Apple (Logic Pro,
  ...
  Goodhertz, HeadRush, iConnectivity, Image-Line (FL Studio), iZotope, Kemper, Kilohearts,
  Klanghelm, Korg, MOTU (Digital Performer), Moog, Native Instruments, Neural DSP, Nord, Novation, OBS Project (OBS
  Studio), Pioneer DJ, Polyend, Positive Grid, PreSonus (Fender Studio, Notion), RME, Sequential, Soundtoys, Steinberg, Strymon, Teenage Engineering, Tokyo
  Dawn Labs, Toontrack, u-he, Universal Audio, Valhalla DSP, Waves, Xfer Records, Zoom and more
...
**Add devices** from the catalogue at `/catalog`. 1,258 devices across 66 vendors, so it
...
| Boss | Avid (Pro Tools) |
| Crumar | Bitwig (Studio) |
| Elektron | Cableguys |
| Empress Effects | Cockos (REAPER) |
| Engine DJ (Denon DJ, Numark, Rane) | FabFilter |
...
| Korg | Moog |
| Line 6 | MOTU (Digital Performer) |
| Neural DSP | Native Instruments |
| Nord | OBS Project (OBS Studio) |
| Novation | PreSonus (Fender Studio, Notion) |
...
src/
  ...
  scrapers/
    ...
    plugins/           # One file per manufacturer (66 scrapers)
