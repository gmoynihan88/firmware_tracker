...
This scrapes 61 manufacturers on a schedule, compares what it finds against the gear
...
- **Scrapes 61 manufacturers** — Ableton, Akai, Apple (Logic Pro,
  ...
  Studio), Pioneer DJ, Positive Grid, PreSonus (Fender Studio, Notion), RME, Soundtoys, Steinberg, Strymon, Teenage Engineering, Tokyo
...
**Add devices** from the catalogue at `/catalog`. 1,194 devices across 61 vendors, so it
...
src/
  ...
  scrapers/
    ...
    plugins/           # One file per manufacturer (61 scrapers)
