...
This scrapes 75 manufacturers on a schedule, compares what it finds against the gear
...
- **Scrapes 75 manufacturers** — 1010music, Ableton, Akai, Apple (Logic Pro,
  ...
  Studio), oeksound, Pioneer DJ, Polyend, Positive Grid, PreSonus (Fender Studio, Notion), RME, Sequential, Serato, Soundtoys, Steinberg, Strymon, Teenage Engineering, Tokyo
...
**Add devices** from the catalogue at `/catalog`. 1,342 devices across 75 vendors, so it
...
| Boss | Cockos (REAPER) |
| Crumar | FabFilter |
| Elektron | GForce Software |
| Empress Effects | Goodhertz |
| Engine DJ (Denon DJ, Numark, Rane) | IK Multimedia |
| Eventide\* | Image-Line (FL Studio) |
| Fender | iZotope |
| Focusrite | Kilohearts |
| Fractal Audio | Klanghelm |
| HeadRush | Modartt (Pianoteq) |
| Hotone | Moog |
| iConnectivity | MOTU (Digital Performer) |
| Keith McMillen | Native Instruments |
| Kemper | OBS Project (OBS Studio) |
| Korg | oeksound |
| Line 6 | PreSonus (Fender Studio, Notion) |
| Mooer | PSPaudioware |
| Neural DSP | Serato |
| Nord | Soundtoys |
| Novation | Steinberg |
| Oberheim | TAL Software |
| Peterson | Tokyo Dawn Labs |
| Pioneer DJ | Toontrack |
| Polyend | u-he |
| Positive Grid\* | Universal Audio |
| QSC | Valhalla DSP |
| RME | Waves |
| Roland | Xfer Records |
| Sequential | XLN Audio |
| Sound-Force |  |
| Strymon |  |
| Tascam |  |
| TC Electronic |  |
...
src/
  ...
  scrapers/
    ...
    plugins/           # One file per manufacturer (75 scrapers)
