...
This scrapes 77 manufacturers on a schedule, compares what it finds against the gear
...
- **Scrapes 77 manufacturers** — 1010music, Ableton, Akai, Apple (Logic Pro,
  ...
  Studio), oeksound, Pioneer DJ, Polyend, Positive Grid, PreSonus (Fender Studio, Notion), RME, Sequential, Serato, Solid State Logic, Soundtoys, Steinberg, Strymon, Teenage Engineering, Tokyo
...
**Add devices** from the catalogue at `/catalog`. 1,398 devices across 77 vendors, so it
...
src/
  ...
  scrapers/
    ...
    plugins/           # One file per manufacturer (77 scrapers)
