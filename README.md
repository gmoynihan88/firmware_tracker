...
This scrapes 47 manufacturers on a schedule, compares what it finds against the gear
...
- **Scrapes 47 manufacturers** — Ableton, Akai, Arturia, Bitwig, Boss, Cableguys,
  ...
  Novation, Soundtoys, Steinberg, Strymon, Teenage Engineering, u-he, Universal Audio,
  Valhalla DSP, Xfer Records, Zoom and more
...
**Add devices** from the catalogue at `/catalog`. 972 devices across 47 vendors, so it
...
src/
  ...
  scrapers/
    ...
    plugins/           # One file per manufacturer (47 scrapers)
