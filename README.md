...
This scrapes 48 manufacturers on a schedule, compares what it finds against the gear
...
- **Scrapes 48 manufacturers** — Ableton, Akai, Arturia, Bitwig, Boss, Cableguys,
  ...
  Novation, Soundtoys, Steinberg, Strymon, Teenage Engineering, Tokyo Dawn Labs, u-he,
  Universal Audio, Valhalla DSP, Xfer Records, Zoom and more
...
**Add devices** from the catalogue at `/catalog`. 990 devices across 48 vendors, so it
...
src/
  ...
  scrapers/
    ...
    plugins/           # One file per manufacturer (48 scrapers)
