...
This scrapes 78 manufacturers on a schedule, compares what it finds against the gear
...
- **Scrapes 78 manufacturers** — 1010music, Ableton, Akai, Apple (Logic Pro,
  MainStage), Arturia, ASM, Audient, Avid (Pro Tools), Bitwig, Boss, Cableguys, Cockos
  (REAPER), Dirtywave, Elektron, Eventide, Empress, Engine DJ (Denon DJ, Numark, Rane), FabFilter, Fender, Focusrite, Fractal Audio,
  ...
  Studio), oeksound, Pioneer DJ, Polyend, Positive Grid, PreSonus (Fender Studio, Notion), RME, Sequential, Serato, Solid State Logic, Soundtoys, Squarp Instruments, Steinberg, Strymon, Teenage Engineering, Tokyo
...
**Add devices** from the catalogue at `/catalog`. 1,403 devices across 78 vendors, so it
...
| Boss | Cockos (REAPER) |
| Crumar | FabFilter |
| Dirtywave | GForce Software |
| Elektron | Goodhertz |
| Empress Effects | IK Multimedia |
| Engine DJ (Denon DJ, Numark, Rane) | Image-Line (FL Studio) |
| Eventide\* | iZotope |
| Fender | Kilohearts |
| Focusrite | Klanghelm |
| Fractal Audio | Modartt (Pianoteq) |
| HeadRush | Moog |
| Hotone | MOTU (Digital Performer) |
| iConnectivity | Native Instruments |
| Keith McMillen | OBS Project (OBS Studio) |
| Kemper | oeksound |
| Korg | PreSonus (Fender Studio, Notion) |
| Line 6 | PSPaudioware |
| Mooer | Serato |
| Neural DSP | Soundtoys |
| Nord | Steinberg |
| Novation | TAL Software |
| Oberheim | Tokyo Dawn Labs |
| Peterson | Toontrack |
| Pioneer DJ | u-he |
| Polyend | Universal Audio |
| Positive Grid\* | Valhalla DSP |
| QSC | Waves |
| RME | Xfer Records |
| Roland | XLN Audio |
| Sequential |  |
...
src/
  ...
  scrapers/
    ...
    plugins/           # One file per manufacturer (78 scrapers)
