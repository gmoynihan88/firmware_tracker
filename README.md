...
This scrapes 65 manufacturers on a schedule, compares what it finds against the gear
...
- **Scrapes 65 manufacturers** — Ableton, Akai, Apple (Logic Pro,
...
**Add devices** from the catalogue at `/catalog`. 1,250 devices across 65 vendors, so it
...
| Line 6 | Moog |
| Neural DSP | MOTU (Digital Performer) |
| Nord | Native Instruments |
| Novation | OBS Project (OBS Studio) |
| Peterson | PreSonus (Fender Studio, Notion) |
...
src/
  ...
  scrapers/
    ...
    plugins/           # One file per manufacturer (65 scrapers)
