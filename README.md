...
This scrapes 41 manufacturers on a schedule, compares what it finds against the gear
...
- **Scrapes 41 manufacturers** — Ableton, Akai, Arturia, Bitwig, Boss, Elektron, Eventide,
  ...
  Teenage Engineering, Universal Audio, Valhalla DSP, Zoom and more
...
**Add devices** from the catalogue at `/catalog`. 917 devices across 41 vendors, so it
...
src/
  ...
  scrapers/
    ...
    plugins/           # One file per manufacturer (41 scrapers)
