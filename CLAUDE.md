...
Firmware Tracker is a FastAPI web app that scrapes manufacturer websites for firmware/software updates for music production hardware and VST plugins, stores them in SQLite, and notifies users when tracked devices have new versions. It uses a plugin-based scraper architecture with 68 manufacturer scrapers.
